...
public class Column implements org.apache.thrift.TBase<Column, Column._Fields>, java.io.Serializable, Cloneable, Comparable<Column> {
  ...
  public Column setName(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public Column setSchema(@org.apache.thrift.annotation.Nullable ColumnSchema schema) {
    this.schema = schema;
    return this;
  }
