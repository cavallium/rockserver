...
public class ColumnSchema implements org.apache.thrift.TBase<ColumnSchema, ColumnSchema._Fields>, java.io.Serializable, Cloneable, Comparable<ColumnSchema> {
  ...
  public ColumnSchema(ColumnSchema other) {
    ...
    if (other.isSetMergeOperatorName()) {
  ...
  public ColumnSchema setMergeOperatorName(@org.apache.thrift.annotation.Nullable java.lang.String mergeOperatorName) {
    this.mergeOperatorName = mergeOperatorName;
    return this;
  }

  public void unsetMergeOperatorName() {
    this.mergeOperatorName = null;
  }

  /** Returns true if field mergeOperatorName is set (has been assigned a value) and false otherwise */
  public boolean isSetMergeOperatorName() {
    return this.mergeOperatorName != null;
  }

  public void setMergeOperatorNameIsSet(boolean value) {
    if (!value) {
      this.mergeOperatorName = null;
    }
  }

  public long getMergeOperatorVersion() {
    return this.mergeOperatorVersion;
  }

  public ColumnSchema setMergeOperatorVersion(long mergeOperatorVersion) {
    this.mergeOperatorVersion = mergeOperatorVersion;
    setMergeOperatorVersionIsSet(true);
    return this;
  }

  public void unsetMergeOperatorVersion() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MERGEOPERATORVERSION_ISSET_ID);
  }

  /** Returns true if field mergeOperatorVersion is set (has been assigned a value) and false otherwise */
  public boolean isSetMergeOperatorVersion() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MERGEOPERATORVERSION_ISSET_ID);
  }

  public void setMergeOperatorVersionIsSet(boolean value) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case MERGE_OPERATOR_NAME:
      if (value == null) {
        unsetMergeOperatorName();
      } else {
        setMergeOperatorName((java.lang.String)value);
      }
      break;

    case MERGE_OPERATOR_VERSION:
      if (value == null) {
        unsetMergeOperatorVersion();
      } else {
        setMergeOperatorVersion((java.lang.Long)value);
      }
      break;
  ...
  public boolean equals(ColumnSchema that) {
    ...
    boolean this_present_mergeOperatorName = true && this.isSetMergeOperatorName();
    boolean that_present_mergeOperatorName = true && that.isSetMergeOperatorName();
    if (this_present_mergeOperatorName || that_present_mergeOperatorName) {
      if (!(this_present_mergeOperatorName && that_present_mergeOperatorName))
        return false;
      if (!this.mergeOperatorName.equals(that.mergeOperatorName))
        return false;
    }

    boolean this_present_mergeOperatorVersion = true && this.isSetMergeOperatorVersion();
    boolean that_present_mergeOperatorVersion = true && that.isSetMergeOperatorVersion();
    if (this_present_mergeOperatorVersion || that_present_mergeOperatorVersion) {
      if (!(this_present_mergeOperatorVersion && that_present_mergeOperatorVersion))
        return false;
      if (this.mergeOperatorVersion != that.mergeOperatorVersion)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetMergeOperatorName()) ? 131071 : 524287);
    if (isSetMergeOperatorName())
      hashCode = hashCode * 8191 + mergeOperatorName.hashCode();
  ...
  public int compareTo(ColumnSchema other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMergeOperatorName(), other.isSetMergeOperatorName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMergeOperatorName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.mergeOperatorName, other.mergeOperatorName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = java.lang.Boolean.compare(isSetMergeOperatorVersion(), other.isSetMergeOperatorVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMergeOperatorVersion()) {
  ...
  public java.lang.String toString() {
    ...
    if (isSetMergeOperatorName()) {
      if (!first) sb.append(", ");
      sb.append("mergeOperatorName:");
      if (this.mergeOperatorName == null) {
        sb.append("null");
      } else {
        sb.append(this.mergeOperatorName);
      }
      first = false;
    }
    if (isSetMergeOperatorVersion()) {
      if (!first) sb.append(", ");
      sb.append("mergeOperatorVersion:");
  ...
  private static class ColumnSchemaStandardScheme extends org.apache.thrift.scheme.StandardScheme<ColumnSchema> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ColumnSchema struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.mergeOperatorName != null) {
        if (struct.isSetMergeOperatorName()) {
          oprot.writeFieldBegin(MERGE_OPERATOR_NAME_FIELD_DESC);
          oprot.writeString(struct.mergeOperatorName);
          oprot.writeFieldEnd();
        }
      }
      if (struct.isSetMergeOperatorVersion()) {
        oprot.writeFieldBegin(MERGE_OPERATOR_VERSION_FIELD_DESC);
