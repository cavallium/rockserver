		...
		return """
				{
				    ...
				    "ingest-behind": %b,
				    "unordered-write": %b,
				    "disable-auto-compactions": %b,
				    "disable-write-slowdown": %b,
				    "max-subcompactions": %s,
				    "max-background-jobs": %s,
				    "fallback-column-options": %s,
				    "column-options": %s
				  }\
				""".formatted(o.followRocksdbOptimizations(),
				o.paranoidChecks(),
				o.useClockCache(),
				o.enableFastGet(),
				o.spinning(),
		...
		return """
				{
				      ...
				      "batch-drr-weight": %d,
				      "competing-batch-read-maximum-active": %d,
				      "competing-batch-write-maximum-active": %d,
				      "competing-batch-write-interval": %s,
				...
				o.batchDrrWeight(),
				o.competingBatchReadMaximumActive(),
				o.competingBatchWriteMaximumActive(),
				quote(o.competingBatchWriteInterval()),
				...
				o.rawScanFileConcurrency(),
				quote(o.rawScanReadaheadBytes()),
		...
		return """
				{
				      ...
				      "block-cache-name": %s,
				      "pin-index-and-filter-blocks": %s,
				      "disable-auto-compactions": %s,
				      "partition-filters": %s,
				      "bloom-filter": %s,
				      "block-size": %s,
				      "write-buffer-size": %s
